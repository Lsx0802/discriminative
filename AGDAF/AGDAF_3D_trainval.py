...
for k in range(1, 6):
    ...
    for i in data_:
        ...
        AP_dataTrain, AP_labelTrain = get_inputOp(
            "/home/public/AGDAF/3D/AP/" + i + "/Train.tfrecords", batch_size,
            1000)
        AP_dataTest, AP_labelTest = get_inputOp(
            "/home/public/AGDAF/3D/AP/" + i + "/Train.tfrecords", batch_size,
            batch_size)
        PVP_dataTrain, PVP_labelTrain = get_inputOp(
            "/home/public/AGDAF/3D/PVP/" + i + "/Train.tfrecords", batch_size,
            1000)
        PVP_dataTest, PVP_labelTest = get_inputOp(
            "/home/public/AGDAF/3D/PVP/" + i + "/Train.tfrecords", batch_size,
            batch_size)
        PC_dataTrain, PC_labelTrain = get_inputOp(
            "/home/public/AGDAF/3D/PC/" + i + "/Train.tfrecords", batch_size,
            1000)
